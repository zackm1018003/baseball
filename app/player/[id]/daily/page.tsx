              ...
              return (
                ...
                {(p.batSpeed !== null || p.exitVelo !== null || p.hitDistance !== null) && (
                  <div className="pl-1 mt-1 flex gap-2">
                    {p.batSpeed !== null && <span className="text-yellow-400 font-semibold" style={{ fontSize: 10 }}>{p.batSpeed.toFixed(1)} <span className="text-gray-500 font-normal">bs</span>{p.batSpeed >= 75 && <span style={{ fontSize: 9 }}>⚡</span>}</span>}

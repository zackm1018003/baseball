      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-panel p-4">
            <div className="flex items-center gap-4">
              <div className="relative w-20 h-20 overflow-hidden bg-bone flex-shrink-0">
                <Image
                  src={currentImage1}
              ...
              <div>
                <h2 className="text-xl font-bold text-ink">{player1.full_name}</h2>
                <div className="text-sm text-ink-3-3 space-y-1">
                  ...
                  {player1.team && (
                    <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium bg-walk text-outcome-fg mt-1">
                      {player1.team}
                    </span>
                  )}
                </div>
          ...
          <div className="bg-panel p-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-ink">{player2.full_name}</h2>
                <div className="text-sm text-ink-3-3 space-y-1">
        ...
        <div className="space-y-4">
          {statCategories.map((category) => (
            <div key={category.title} className="bg-panel p-4">
              <h3 className="text-lg font-bold text-ink mb-3 border-b border-ink/20 pb-2">
                {category.title}
              </h3>
                ...
                {category.stats.map((stat) => {
                  ...
                  return (
                    <div key={stat.label} className="grid grid-cols-3 gap-4 items-center text-sm">
                      ...
                      <div
                        className={`text-right font-semibold ${
                          stat.player1Better === true
                            ? 'text-hit bg-bone px-2 py-1 rounded'
                            : 'text-ink-2'
                        }`}
                      >
                        {stat.player1Value}
                        {percentile1 !== null && percentile1 !== undefined && (
                          <span className="text-xs ml-1 text-ink-4-3">
                            ({percentile1}th)
                          </span>
                        )}
                      </div>
                      ...
                      {/* Stat Label */}
                      <div className="text-center text-ink-3-3 font-medium">
                        {stat.label}
                      </div>

      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8">
        <div className="container mx-auto px-4">
          <div className="bg-panel dark:bg-panel p-8 text-center">
            <h1 className="text-2xl font-bold text-ink dark:text-white mb-4">Invalid Comparison</h1>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-6">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <h1 className="text-3xl font-bold text-ink dark:text-white mb-6 text-center">Player Comparison</h1>

        {/* Player Headers */}
        <div className="grid grid-cols-2 gap-4 mb-6">
          {/* Player 1 */}
          <div className="bg-panel dark:bg-panel p-4">
            <div className="flex items-center gap-4">
              <div className="relative w-20 h-20 overflow-hidden bg-bone dark:bg-bone flex-shrink-0">
                <Image
                  src={currentImage1}
              ...
              <div>
                <h2 className="text-xl font-bold text-ink dark:text-white">{player1.full_name}</h2>
                <div className="text-sm text-ink-3 dark:text-ink-3 space-y-1">
                  ...
                  {player1.team && (
                    <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium bg-walk dark:bg-blue-900 text-outcome-fg dark:text-blue-200 mt-1">
                      {player1.team}
                    </span>
                  )}
                </div>
          ...
          <div className="bg-panel dark:bg-panel p-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-ink dark:text-white">{player2.full_name}</h2>
                <div className="text-sm text-ink-3 dark:text-ink-3 space-y-1">
        ...
        <div className="space-y-4">
          {statCategories.map((category) => (
            <div key={category.title} className="bg-panel dark:bg-panel p-4">
              <h3 className="text-lg font-bold text-ink dark:text-white mb-3 border-b border-gray-200 dark:border-ink/20 pb-2">
                {category.title}
              </h3>

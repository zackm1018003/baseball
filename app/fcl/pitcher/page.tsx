...
interface PitchType {
  ...
  whiff: number | null; whiffs: number;
            ...
            <div className="mx-4 mb-3" style={th.sectionBorder}>
              ...
              <div className="grid grid-cols-8 divide-x divide-ink/10" style={{ background: th.tableBg }}>
                {[
                  ...
                  { label: 'BB%',  value: gameLine.bf > 0 ? `${(gameLine.bb / gameLine.bf * 100).toFixed(1)}%` : '—' },
                  { label: 'K%',   value: gameLine.bf > 0 ? `${(gameLine.k  / gameLine.bf * 100).toFixed(1)}%` : '—' },

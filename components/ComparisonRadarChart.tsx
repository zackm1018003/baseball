...
export default function ComparisonRadarChart({
  ...
  const radarData = [
    ...
    {
      stat: 'Swing Length',
      [player1Name]: percentiles1['swing_length'] || 0,
      [player2Name]: percentiles2['swing_length'] || 0,
      fullMark: 100,
    },
    {
      stat: 'Z-Swing %',
      [player1Name]: percentiles1['z-swing%'] || 0,
      [player2Name]: percentiles2['z-swing%'] || 0,
      fullMark: 100,
    },
    {
      stat: 'Z-Whiff %',
      [player1Name]: percentiles1['z-whiff%'] || 0,
      [player2Name]: percentiles2['z-whiff%'] || 0,
      fullMark: 100,
    },
    {
      stat: 'Chase %',

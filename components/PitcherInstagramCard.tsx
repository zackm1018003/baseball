        ...
        >
          ...
          <div>
            ...
            <div style={{
              ...
              borderBottom: '1px solid #1e3a5f', marginBottom: 3,
            }}>
              <span>Pitch</span>
            ...
            {topPitches.map((pt, i) => {
              ...
              return (
                <div key={pt.name} style={{
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ background: color, color: '#fff', fontSize: 11, fontWeight: 800, padding: '2px 6px', borderRadius: 3, flexShrink: 0 }}>{short}</span>
